...
if __name__ == '__main__':
    ...
    g_vel_scales[0] = fetch_param('~angular_scale', 15.0)
    g_vel_scales[1] = fetch_param('~linear_scale', 15.0)
    g_vel_ramps[0] = fetch_param('~angular_accel', 3.0)
    g_vel_ramps[1] = fetch_param('~linear_accel', 3.0)
